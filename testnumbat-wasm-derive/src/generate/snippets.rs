pub fn where_self_big_int() -> proc_macro2::TokenStream {
	quote! {
		where
			Self::BigUint: testnumbat_wasm::api::BigUintApi,
...
pub fn where_api_big_int() -> proc_macro2::TokenStream {
	quote! {
		where
			A::BigUint: testnumbat_wasm::api::BigUintApi,
			...
			A::BigInt: testnumbat_wasm::api::BigIntApi,
...
pub fn api_where() -> proc_macro2::TokenStream {
	...
	quote! {
	  #where_self_big_int
		T: testnumbat_wasm::api::ContractBase
		 + testnumbat_wasm::api::ErrorApi
		 + testnumbat_wasm::api::BlockchainApi
		 + testnumbat_wasm::api::CallValueApi
		 + testnumbat_wasm::api::SendApi
		 + testnumbat_wasm::api::EndpointArgumentApi
		 + testnumbat_wasm::api::EndpointFinishApi
		 + testnumbat_wasm::api::StorageReadApi
		 + testnumbat_wasm::api::StorageWriteApi
		 + testnumbat_wasm::api::CryptoApi
		 + testnumbat_wasm::api::LogApi
		 + Clone
		 + 'static,
	}
}
