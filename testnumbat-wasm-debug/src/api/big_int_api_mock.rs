...
use testnumbat_wasm::api::BigIntApi;
...
impl testnumbat_wasm::abi::TypeAbi for RustBigInt {
	fn type_name() -> String {
		String::from("BigInt")
	}
}

impl testnumbat_wasm::api::BigIntApi for RustBigInt {
	...
	fn sign(&self) -> testnumbat_wasm::api::Sign {
		match self.0.sign() {
			num_bigint::Sign::Minus => testnumbat_wasm::api::Sign::NoSign,
