...
fn check_state(accounts: &testdenali::CheckAccounts, state: &mut BlockchainMock) {
...
fn update_block_info(block_info: &mut super::BlockInfo, testdenali_block_info: &testdenali::BlockInfo) {
