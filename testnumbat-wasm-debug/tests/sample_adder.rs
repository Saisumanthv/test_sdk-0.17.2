...
mod module_1 {
	...
	//////// CONTRACT TRAIT /////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////////////////////////
	pub trait VersionModule: testnumbat_wasm::api::ContractBase + Sized
	where
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	pub trait AutoImpl: testnumbat_wasm::api::ContractBase {}
	...
	pub trait EndpointWrappers: VersionModule + testnumbat_wasm::api::ContractPrivateApi
	where
		for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Mul<&'b Self::BigUint, Output = Self::BigUint>,
		...
		for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
	{
		...
		fn call_version(&self) {
			...
			testnumbat_wasm::io::EndpointResult::finish(&result, self.finish_api())
		}
	...
	impl testnumbat_wasm::api::ContractAbiProvider for AbiProvider {
		type BigUint = testnumbat_wasm::api::uncallable::BigUintUncallable;
		type BigInt = testnumbat_wasm::api::uncallable::BigIntUncallable;
		type Storage = testnumbat_wasm::api::uncallable::UncallableApi;
		type SendApi = testnumbat_wasm::api::uncallable::UncallableApi;

		fn abi() -> testnumbat_wasm::abi::ContractAbi {
			let mut contract_abi = testnumbat_wasm :: abi :: ContractAbi { docs : & [ "One of the simplest smart contracts possible," , "it holds a single variable in storage, which anyone can increment." ] , name : "Adder" , constructor : None , endpoints : Vec :: new ( ) , type_descriptions : < testnumbat_wasm :: abi :: TypeDescriptionContainerImpl as testnumbat_wasm :: abi :: TypeDescriptionContainer > :: new ( ) , } ;
	...
	pub trait ProxyTrait: testnumbat_wasm::api::ProxyObjApi + Sized {
		fn version(
			self,
		) -> ContractCall<Self::SendApi, <Self::BigInt as testnumbat_wasm::io::EndpointResult>::DecodeAs>
		{
			...
			let mut ___contract_call___ = testnumbat_wasm::types::new_contract_call(
				...
				___payment___,
				___nonce___,
				testnumbat_wasm::types::BoxedBytes::from(&b"version"[..]),
			);
			___contract_call___
		}
	}
...
mod sample_adder {
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	pub trait Adder:
		super::module_1::VersionModule + testnumbat_wasm::api::ContractBase + Sized
	where
		Self::BigInt: testnumbat_wasm::api::BigIntApi,
		for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Mul<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Div<&'b Self::BigUint, Output = Self::BigUint>,
		...
		for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
	{
		fn get_sum(&self) -> Self::BigInt {
			...
			testnumbat_wasm::storage_get(self.get_storage_raw(), &key[..])
		}
		fn set_sum(&self, sum: &Self::BigInt) {
			let key: &'static [u8] = b"sum";
			testnumbat_wasm::storage_set(self.get_storage_raw(), &key[..], &sum);
		}
		fn callback(&self) {}
		fn callbacks(&self) -> self::CallbackProxyObj<Self::SendApi> {
			<self::CallbackProxyObj::<Self::SendApi> as testnumbat_wasm::api::CallbackProxyObjApi>::new_cb_proxy_obj(self.send())
		}
	}

	pub trait EndpointWrappers:
		Adder + testnumbat_wasm::api::ContractPrivateApi + super::module_1::EndpointWrappers
	where
		for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Mul<&'b Self::BigUint, Output = Self::BigUint>,
		...
		for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
	{
		...
		fn call_get_sum(&self) {
			self.call_value().check_not_payable();
			testnumbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 0i32);
		...
		fn call_init(&self) {
			self.call_value().check_not_payable();
			testnumbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
			let initial_value = testnumbat_wasm::load_single_arg::<Self::ArgumentApi, Self::BigInt>(
				self.argument_api(),
				0i32,
		...
		fn call_add(&self) {
			self.call_value().check_not_payable();
			testnumbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
			let value = testnumbat_wasm::load_single_arg::<Self::ArgumentApi, Self::BigInt>(
				self.argument_api(),
				0i32,
				ArgId::from(&b"value"[..]),
			);
	...
	pub trait ProxyTrait: testnumbat_wasm::api::ProxyObjApi + super::module_1::ProxyTrait {
		fn get_sum(
			self,
		) -> testnumbat_wasm::types::ContractCall<
			Self::SendApi,
			<Self::BigInt as testnumbat_wasm::io::EndpointResult>::DecodeAs,
		> {
			let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
				self.into_fields();
			let mut ___contract_call___ = testnumbat_wasm::types::new_contract_call(
				...
				___payment___,
				___nonce___,
				testnumbat_wasm::types::BoxedBytes::from(&b"get_sum"[..]),
			);
			___contract_call___
		}
		fn add(
			self,
			amount: &Self::BigInt,
		) -> ContractCall<Self::SendApi, <SCResult<()> as testnumbat_wasm::io::EndpointResult>::DecodeAs>
		{
			let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
				self.into_fields();
			let mut ___contract_call___ = testnumbat_wasm::types::new_contract_call(
				...
				___payment___,
				___nonce___,
				testnumbat_wasm::types::BoxedBytes::from(&b"add"[..]),
			);
			testnumbat_wasm::io::serialize_contract_call_arg(
				amount,
	...
	//////// CONTRACT OBJECT ////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////////////////////////
	pub struct ContractObj<A: testnumbat_wasm::api::ContractBase> {
		api: A,
	}
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	impl<A> testnumbat_wasm::api::ContractBase for ContractObj<A>
	where
		A: testnumbat_wasm::api::ContractBase
	...
	impl<A> testnumbat_wasm::api::ContractPrivateApi for ContractObj<A>
	where
		A: testnumbat_wasm::api::ContractBase
			+ testnumbat_wasm::api::ErrorApi
			+ testnumbat_wasm::api::EndpointArgumentApi
	...
	impl<A> testnumbat_wasm::api::CallableContract<A> for ContractObj<A>
	where
		A: testnumbat_wasm::api::ContractBase
			+ testnumbat_wasm::api::ErrorApi
			+ testnumbat_wasm::api::EndpointArgumentApi
	...
	impl testnumbat_wasm::api::ContractAbiProvider for AbiProvider {
		...
		fn abi() -> testnumbat_wasm::abi::ContractAbi {
			...
			contract_abi.coalesce(
				<super::module_1::AbiProvider as testnumbat_wasm::api::ContractAbiProvider>::abi(),
			);
			contract_abi
		}
	}
	...
	pub struct Proxy<SA>
	where
		SA: testnumbat_wasm::api::SendApi + 'static,
	{
		pub api: SA,
		pub address: Address,
		pub payment_token: testnumbat_wasm::types::TokenIdentifier,
		pub payment_amount: SA::AmountType,
		pub payment_nonce: u64,
	}

	impl<SA> testnumbat_wasm::api::ProxyObjApi for Proxy<SA>
	where
		SA: testnumbat_wasm::api::SendApi + 'static,
	{
		...
		fn new_proxy_obj(api: SA, address: Address) -> Self {
			Proxy {
				api,
				address,
				payment_token: testnumbat_wasm::types::TokenIdentifier::rewa(),
	...
	impl<SA> super::module_1::ProxyTrait for Proxy<SA> where SA: testnumbat_wasm::api::SendApi {}

	impl<SA> ProxyTrait for Proxy<SA> where SA: testnumbat_wasm::api::SendApi {}
	...
	impl<SA> testnumbat_wasm::api::CallbackProxyObjApi for CallbackProxyObj<SA>
	where
		SA: testnumbat_wasm::api::SendApi + 'static,
	{
		type BigUint = SA::AmountType;
	...
	pub trait CallbackProxy: testnumbat_wasm::api::CallbackProxyObjApi + Sized {
		fn my_callback(self, caller: &Address) -> testnumbat_wasm::types::CallbackCall {
			let ___api___ = self.into_api();
			let mut ___closure_arg_buffer___ = testnumbat_wasm::types::ArgBuffer::new();
			testnumbat_wasm::io::serialize_contract_call_arg(
				caller,
				&mut ___closure_arg_buffer___,
				___api___.clone(),
			);
			testnumbat_wasm::types::CallbackCall::from_arg_buffer(
				&b"my_callback"[..],
				&___closure_arg_buffer___,
			)
		}
	}
	impl<SA> self::CallbackProxy for CallbackProxyObj<SA> where SA: testnumbat_wasm::api::SendApi + 'static {}
}

#[test]
fn test_add() {
	use testnumbat_wasm::api::ContractBase;
	use testnumbat_wasm_debug::api::RustBigInt;
