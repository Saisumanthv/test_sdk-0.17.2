...
cp -R contracts/examples/adder/testdenali \
...
cp -R contracts/examples/crowdfunding-dcdt/testdenali \
...
cp -R contracts/examples/ping-pong-rewa/testdenali \
...
cp -R contracts/examples/multisig/testdenali \
...
cp -R contracts/examples/rewa-dcdt-swap/testdenali \
...
cp -R contracts/examples/erc20/testdenali \
...
cp -R contracts/feature-tests/basic-features/testdenali \
...
cp -R contracts/feature-tests/payable-features/testdenali \
...
cp -R contracts/feature-tests/async/testdenali \
